      ...
      case 'gdrive':
        return (
          <svg width={48} height={42} viewBox="0 0 48 42">
            <path d="M16 2 2 30 42 L8 42 L0 30 Z" fill="none" />
            <path d="M16 2 2 24 L4 24 Z" fill="#34a853" transform="translate(2,2)" />
            <path d="M32 2 28 28 6 Z" fill="#fbbc04" transform="translate(0,2)" />
            <path d="M6 28 28 38 38 Z" fill="#4285f4" />
          </svg>
        );
      default: // dropbox
        return (
          <svg width={48} height={42} viewBox="0 0 48 42">
            <path d="M12 0 8 16 L0 8 Z" fill="#0061ff" />
            <path d="M36 0 8 16 8 Z" fill="#0061ff" />
            <path d="M12 18 26 34 L0 26 Z" fill="#0061ff" />
            <path d="M36 18 26 34 26 Z" fill="#0061ff" />
          </svg>
        );
    }
  })();
