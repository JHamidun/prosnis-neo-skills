          ...
          >
            {checked && (
              <svg width="18" height="18" viewBox="0 0 18 18">
                <path d="M3 9.5 L7.2 13.5 4.5" stroke="#fff" strokeWidth="3.2" fill="none" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            )}
          </div>
...
const Cursor: React.FC<{ frame: number }> = ({ frame }) => {
  ...
  return (
    ...
    >
      <path d="M2 1 L2 17 L6.5 13.2 L9.4 20.4 18.7 L9.5 12 11.6 Z" fill={G.ink} stroke="#fff" strokeWidth="1.4" />
    </svg>
  );
};
